...
use Notadd\Foundation\Database\Eloquent\Relations\Pivot;
use Notadd\Foundation\Database\Eloquent\Relations\HasOne;
use Notadd\Foundation\Database\Eloquent\Relations\HasMany;
use Notadd\Foundation\Database\Eloquent\Relations\MorphTo;
use Notadd\Foundation\Database\Eloquent\Relations\Relation;
use Notadd\Foundation\Database\Eloquent\Relations\MorphOne;
use Notadd\Foundation\Database\Eloquent\Relations\MorphMany;
use Notadd\Foundation\Database\Eloquent\Relations\BelongsTo;
use Notadd\Foundation\Database\Eloquent\Relations\MorphToMany;
...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable {
    ...
    /**
     * @param \Notadd\Foundation\Database\Eloquent\ScopeInterface $scope
     * @return void
     */
    ...
    /**
     * @param \Notadd\Foundation\Database\Eloquent\ScopeInterface $scope
     * @return \Notadd\Foundation\Database\Eloquent\ScopeInterface|null
     */
     ...
     * @param array $attributes
     * @return $this
     * @throws \Notadd\Foundation\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \Notadd\Foundation\Database\Eloquent\Relations\HasOne
     */
     ...
     * @param string $id
     * @param string $localKey
     * @return \Notadd\Foundation\Database\Eloquent\Relations\MorphOne
     */
     ...
     * @param string $foreignKey
     * @param string $localKey
     * @return \Notadd\Foundation\Database\Eloquent\Relations\HasMany
     */
     ...
     * @return \Notadd\Foundation\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     * @param string $id
     * @param string $localKey
     * @return \Notadd\Foundation\Database\Eloquent\Relations\MorphMany
     */
     ...
     * @param string $otherKey
     * @param bool $inverse
     * @return \Notadd\Foundation\Database\Eloquent\Relations\MorphToMany
     */
    ...
    protected function getRelationshipFromMethod($method) {
        ...
        if(!$relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type ' . 'Notadd\Foundation\Database\Eloquent\Relations\Relation');
        }
