...
/**
 * Class MenuGroupEditRequest
 * @package Notadd\Menu\Requests
 */
class MenuGroupEditRequest extends FormRequest {
    /**
     * @return bool
     */
    ...
    public function rules() {
        return [
            'title' => 'required|unique:menu_groups,title,' . $this->route('group') . '|alpha_dash|max:300',
            'alias' => 'required|unique:menu_groups,alias,' . $this->route('group') . '|alpha_dash|max:300',
        ];
    }
}