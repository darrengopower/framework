...
<div class="page page-auth clearfix">
    <div class="auth-container">
        <h1 class="site-logo h2 mb15"><a href="{{ url('/') }}"><span>{{ Setting::get('site.company', 'iBenchu CMS')  }}</span>&nbsp;内容管理系统</a></h1>
        ...
        <div class="form-container">
            ...
            <form action="{{ url('admin/login') }}" class="form-horizontal" method="POST">
                ...
                <div class="clearfix"><a href="{{ url('password/email') }}" class="right small">忘记密码了吗？</a></div>
