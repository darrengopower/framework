            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="panel panel-lined clearfix mb30">
                        <div class="panel-heading mb20"><i>创建管理</i></div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="title" placeholder="请输入标题" value="{{ Request::old('title', $article->title) }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
                                    <script id="editor-container" type="text/plain" data-toggle="ueditor" name="content">{!! Request::old('content', $article->content) !!}</script>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-lined clearfix mb30">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="author" value="{{ Request::old('author', $article->author) }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">标签</label>
                                <div class="col-md-8">
                                    <textarea class="form-control" name="keyword" rows="3">{{ Request::old('keyword', $article->keyword) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">摘要</label>
                                <div class="col-md-8">
                                    <textarea class="form-control" name="description" rows="11">{{ Request::old('description', $article->description) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">来源</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="from_author" value="{{ Request::old('from_author', $article->from_author) }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">来源链接</label>
                                <div class="col-md-8">
                                    <textarea class="form-control" name="from_url" rows="2">{{ Request::old('from_url', $article->from_url) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" data-toggle="datetimepicker" name="created_at" readonly value="{{ Request::old('created_at', $article->created_at) }}">
                                </div>
                            </div>
                            <div class="form-group">
