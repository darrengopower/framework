...
@section('title'){{ app('setting')->get('site.company', 'iBenchu CMS')  }}后台管理系统@endsection
@section('content')
<div class="page page-auth clearfix">
    <div class="auth-container">
        <div class="auth-container-wrap">
            <h1 class="site-logo h2 mb15"><a href="{{ url('/') }}"><span>{{ app('setting')->get('site.company', 'Notadd CMS')  }}</span>&nbsp;内容管理系统</a></h1>
