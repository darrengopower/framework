                ...
                <div class="panel panel-lined clearfix mb30">
                    ...
                    <form class="form-horizontal col-md-12" action="{{ url('admin/site') }}" autocomplete="off" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="domain" value="{{ Request::old('domain', $domain) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">备案信息</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="beian" value="{{ Request::old('beian', $beian) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">站长邮箱</label>
                            <div class="col-md-4">
                                <input type="email" class="form-control" name="email" value="{{ Request::old('email', $email) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">统计代码</label>
                            <div class="col-md-4">
                                <textarea class="form-control" name="statistics" rows="10">{{ Request::old('statistics', $statistics) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">版权信息</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="copyright" value="{{ Request::old('copyright', $copyright) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">公司名称</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="company" value="{{ Request::old('company', $company) }}">
                            </div>
                        </div>
                        <div class="form-group">
