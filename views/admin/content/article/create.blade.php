                    ...
                    <div class="panel panel-lined clearfix mb30">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="title" placeholder="请输入标题" value="{{ Request::old('title') }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
                                    <script id="editor-container" type="text/plain" data-toggle="ueditor" name="content">{!! Request::old('content') !!}</script>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-lined clearfix mb30">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" name="description" rows="11">{{ Request::old('description') }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">来源</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="from_author" value="{{ Request::old('from_author') }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">来源链接</label>
                                <div class="col-md-8">
                                    <textarea class="form-control" name="from_url" rows="2">{{ Request::old('from_url') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
