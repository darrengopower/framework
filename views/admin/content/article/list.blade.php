            ...
            <div class="col-md-12">
                <div class="panel panel-lined clearfix mb30">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th class="col-md-5">文章标题</td>
                                <th class="col-md-2">所属栏目</td>
                                <th class="col-md-2">创建时间</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{ url('article/' . $article->id) }}" target="_blank"><strong>{{ $article->title }}</strong></a></td>
                                <td><a href="{{ url('admin/article/' . $article->category->id) }}">{{ $article->category->title }}</a></td>
